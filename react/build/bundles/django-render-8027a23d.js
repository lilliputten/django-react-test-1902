...
/******/ 		return __webpack_require__.p + "" + ({"About":"About","Contacts":"Contacts","Home":"Home"}[chunkId]||chunkId) + "-" + {"About":"1a3aba6e","Contacts":"dc6920bb","Home":"48c5ff23"}[chunkId] + ".js"
/******/ 	}
/******/
...
/******/ 	deferredModules.push(["./react/src/django-render.js","vendor","common"]);
...
/* harmony import */ var _components_layout_App_App__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/layout/App/App */ "./react/src/components/layout/App/App.jsx");
...
var preloadAll = react_loadable__WEBPACK_IMPORTED_MODULE_3___default.a.preloadAll();
// On all chunks load finished...
preloadAll.then(function () {
  // console.log('test-bundles: loadable.preloadAll', loadable);
  var url = context.location.path;
  // Render after all async chunks loaded!
  var element =
  react__WEBPACK_IMPORTED_MODULE_0__["createElement"](react_router_dom__WEBPACK_IMPORTED_MODULE_2__["StaticRouter"], { location: url, context: context },
  react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_components_layout_App_App__WEBPACK_IMPORTED_MODULE_4__["default"], { mode: "default" }));


  var result = react_dom_server__WEBPACK_IMPORTED_MODULE_1___default.a.renderToString(element);
...
/******/ });
//# sourceMappingURL=django-render-8027a23d.js.map